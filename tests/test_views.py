...
def create_redirect_page_test(page_name):
    """Creator for test valid page redirect.
...
auth_pages = (
    ...
    ('/tutorials/', 'tutorials', 'pages/tutorials.html'),
)
...
regular_pages = (
    ...
    ('/404/', '404_page', '404.html'),
    ('/search/', 'search', 'pages/search_page.html'),
)
